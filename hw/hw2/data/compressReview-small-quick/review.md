...
processFun <- function(input, all, parallel = TRUE, small = FALSE, training = FALSE) {
    ...
    add.checkin <- processCheckin(as.character(review$business_id), checkin.a = checkin.a, 
        small = small, parallel = parallel)
    
    ## Process the business info
    add.business <- processBusiness(as.character(review$business_id), business.a = business.a, 
        parallel = parallel)
...
## [5] formatR_0.7     stringr_0.6.2   tools_3.0.0
```
